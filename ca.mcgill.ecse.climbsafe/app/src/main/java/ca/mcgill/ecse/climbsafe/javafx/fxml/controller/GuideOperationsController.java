...
public class GuideOperationsController {
	...
	public void registerGuideAction(ActionEvent event) {
	  ...
	  try {
        ClimbSafeFeatureSet3Controller.registerGuide(guideEmail.getText(), guidePassword.getText(), guideName.getText(), guideContact.getText());
      } catch (Exception e) {
	...
	public void updateGuideAction(ActionEvent event) {
	    ...
	    try {
	        ClimbSafeFeatureSet3Controller.updateGuide(updtGuideEmail.getText(), newGuidePassword.getText(), newGuideName.getText(), newGuideContact.getText());
	      } catch (Exception e) {
	        ViewUtils.showError(e.getMessage());
	      }
	}
