 ...
 * This method creates a new piece of equipment in the ClimbSafe system with a unique name, a weight, and a price per week 
 * If the input for the piece is not correct, then the method outputs an invalid input error
 */
  public static void addEquipment(String name, int weight, int pricePerWeek)
	...
	//Checks to see if equipment with same name already exists in the system and outputs an error if that is the case 
  ...
  /** 
   *This method checks the common conditions that are tested whether the item is being added or updated 
   *@author Tinetendo Makata
   * @param weight
   * @param name
   * @param pricePerWeek
