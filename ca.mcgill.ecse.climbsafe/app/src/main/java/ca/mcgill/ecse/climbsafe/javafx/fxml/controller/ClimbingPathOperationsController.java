...
public class ClimbingPathOperationsController {
	...
	public void AddPath(ActionEvent event) {
	  ...
	  if (!ViewUtils.isAlpha(newPathName.getText())|| !ViewUtils.isAlpha(newPathDifficulty.getText())){
	...
	public void UpdatePath(ActionEvent event) {
	  ...
	  if (!ViewUtils.isAlpha(oldPathName.getText())|| !ViewUtils.isAlpha(updatedPathDifficulty.getText()) ||!ViewUtils.isAlpha(updatedPathName.getText()) ){
        ViewUtils.showError("The input must only contain letters.");
        return;
      }
      try { 
